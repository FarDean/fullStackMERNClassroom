...
export default function Signin() {
	...
	return (
		<Layout style={{ minHeight: "95vh" }}>
			<Helmet>
				<title>FarDean's Classroom - Sign In</title>

				<meta name="title" content="FarDean's Classroom - Sign In" />
				<meta
					name="description"
				...
				<meta property="og:title" content="FarDean's Classroom - Sign In" />
				<meta
				...
				<meta property="twitter:title" content="FarDean's Classroom - Sign In" />
				<meta
