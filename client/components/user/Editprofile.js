      ...
      <Layout style={{minHeight:'95vh'}}>
        ...
        <Row justify='center'>
          <Form.Item>
            ...
            >
              {!loading ? <img src={imageUrl} key={Date.now()} alt="avatar" style={{ width: '100%' }} /> : uploadButton}
            </Upload>
          </Form.Item>
        </Row>
        <Row>
            ...
            <Form.Item>
              <Form.Item
                  ...
                  <Form.Item
                    ...
                    name='description'
                  >
                    <Input.TextArea  allowClear onChange={e=>setDescription(e.target.value)} placeholder='Write something about yourself!' />
                  </Form.Item>
                  <Form.Item
                      label='Teacher'
                      name='isTeacher'
