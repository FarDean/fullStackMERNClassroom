...
export default function Editpro({match}) {
    const {error,personalInfo,getPersonalInfo,setToNull,updateUser,message} = useContext(GlobalContext)
            ...
            <Col style={{width:'90%'}}>
                ...
                >
                    ...
                    <Form.Item name='phone' label='Mobile' rules={[
                        ...
                        <Input addonBefore={prefixSelector} style={{width:'100%'}} onChange={e=>setPhone(e.target.value)} />
                    </Form.Item>
                    ...
                    <Form.Item
                        ...
                        name='isTeacher'
                    >
                        <Switch checkedChildren="Yes" unCheckedChildren="No" checked={isTeacher} onChange={checked=>setIsTeacher(checked)} />
                    </Form.Item>
                    {decodedJwt(authenticated()).isAdmin && 
                        ...
                        name='isAdmin'
                    >
                        <Switch checkedChildren="Yes" unCheckedChildren="No" checked={isAdmin} disabled={!decodedJwt().isAdmin} onChange={checked=>setIsAdmin(checked)} />
                    </Form.Item>
                    }
                    <Row justify='center'>
                        <Col>
                            <Form.Item>
                                <Button onClick={onClick} type="primary" htmlType="submit" loading={loading}>
                                Submit
                                </Button>
                            </Form.Item>
                        </Col>
    ...
    return (
        <Layout style={{minHeight:'95vh'}}>
            ...
            <Row justify='center'>
                {_.isEmpty(personalInfo)  ? <Passform /> : <Edit /> }
